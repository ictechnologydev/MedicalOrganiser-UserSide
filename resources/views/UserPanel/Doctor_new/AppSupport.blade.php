    ...
    .head{
      ...
      justify-content: space-between;
          ...
          <div class="nav-item dropdown d-none d-md-flex me-3">
              <a href="javascript:void(3);" class="btn btn-primary my-2 px-2 nav-link px-0 show_notification">
                🔔
    ...
    <div class="offcanvas-body">
        <form>
            ...
            <div class="mb-3">
              ...
              <div class="mb-3">
                <label for="images" class="form-label">Add 2 Iamges</label>
...
var pageTitle = "App Support - {{env('APP_NAME')}}";
