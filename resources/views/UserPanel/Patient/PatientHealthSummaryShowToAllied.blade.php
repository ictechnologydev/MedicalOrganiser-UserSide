          ...
          <a type="button" href="javascript:void(3);" class="btn btn-primary my-2 ps-3 pe-3 nav-link px-0 show_notification btn btn-primary position-relative">
            ...
            <div class="row d-flex justify-content-center mb-3 ">
                <div class="col-6">
                    ...
                    <select class="form-control mt-1 patient_select" onchange="setCookie('section_patient',this.value, 1); window.location.href='/show-patient-health-summary-to-allied'; " style="width:100px;margin: auto;">
...
function get_my_patients_arr(){
  ...
  "Authorization": `Bearer ${getCookie('BearerToken')}`,
    ...
    type: "POST", 
    url: `{{config('app.api_url')}}/api/allied/my-patient-all`,
    data: {
