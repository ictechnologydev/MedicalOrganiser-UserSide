...
<div>
    <div class="container-fluid p-3 main-container-content">
            ...
            <div class="container-fluid p-3 main-container-content">
                ...
                <div class="welcome-note-container p-2 mb-1">
                    ...
                    <div class="row justify-content-between">
                        <div class="col-2 ">
                            <label><p style="font-size:15px" class="mt-1 mb-0">Search Allied Professional By Id/Email</h1></label>
                        </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="d-flex justify-content-start modal-header bg-primary text-white">
                        <h5 class="me-2">Share profile to</h5><h5 id="professional_email"></h5>
                    </div>
                    <div class="modal-body">
                        <input type="hidden" name="allied_professional_id" class="allied_professional_id"/>
                        <label for="additionalInfo">Special Note for your Allied Professional</label>
        ...
        <div id="moduless" class="h5 text-primary"><strong>${module_managers[i]['name']}</strong></div>`;
            ...
            function getAlliedProfessionals(from, pagination) {
                loader(true);
                $.ajax({
                    headers: {
                        "Accept": "application/json",
            ...
            $(document).on('click', '.share-button', function() {
                ...
                var alliedEmail = $(this).data('email');
                $('#shareModal .allied_professional_id').val(alliedId);
                $('#shareModal .modal-header #professional_email').text(alliedEmail);
            ...
            function send_profile(){
                ...
                const formData={
                    ...
                    "allied_professional_id": $('.allied_professional_id').val(),
                    "patient_accept_or_reject": 1,
                    "allied_professional_notification": 1,
                ...
                $.ajax({
                    ...
                    type: "POST",
                    url: "{{config('app.api_url')}}/api/users/request-to-allied-professional-store",
                    data:formData,
                    success: function(response) {
            ...
            // function getAlliedProfessionals() {
            //   loader(true);
            //   $.ajax({
            //     headers: {
            //       "Accept": "application/json",
            ...
            // function searchDoctors(request_to_allied_profess1) {

            //     console.log(request_to_allied_profess1,'23232323');
            //     var searchQuery = $("#search-query").val().trim().toLowerCase();
            ...
            //       var filterAlliedProfessional = request_to_doctor.filter(function (doctor) {
            ...
            //             <td>${obj.doctor_id_number}</td>
            //             <td>${obj.full_name}</td>
            //             <td><a class="btn btn-primary btn-sm decline-button" data-id="${filterAlliedProfessional[i].id}">Share</a></td>
            //           </tr>`;
            //       }
