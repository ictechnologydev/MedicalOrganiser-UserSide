        ...
        <small>Dashaboard - Share with Doctor</small>
        ...
        <button type="button"id="submitBtn" onclick="send_profile()"class="btn btn-secondary" style="background-color:#02b2b0;outline:none;border:none"data-dismiss="modal">Submit</button>
        ...
        <td>${request_to_doctor[i]?.rejected_date ? request_to_doctor[i]?.rejected_date: ""}</td>
