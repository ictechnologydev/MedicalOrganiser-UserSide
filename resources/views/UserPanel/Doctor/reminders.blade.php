        ...
        <form>
            ...
            <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control unique_id"  name="unique_id"placeholder="Add Unique Id...">
              </div>
...
function storeModuleId() {
    ...
    $.ajax({
        ...
        responseElement.title = 'Response';
        responseElement.textContent = update.status;
